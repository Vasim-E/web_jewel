        ...
        <div className="min-h-screen flex items-center justify-center bg-background py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-md w-full space-y-8 p-10 bg-card-bg shadow-xl rounded-xl relative z-10 animate-fade-in-up">
                <div className="text-center">
                    <span className="text-primary tracking-[0.3em] uppercase text-xs block mb-4 font-bold">Join Us</span>
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="text-center mt-6">
                        <Link href={`/login?redirect=${redirect}`} className="text-xs text-gray-500 hover:text-primary transition-colors uppercase tracking-widest border-b border-transparent hover:border-primary pb-1">
